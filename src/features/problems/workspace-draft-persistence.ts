...
interface WorkspaceDraftPersistenceOptions {
  clock: Clock;
...
export class WorkspaceDraftPersistence {
  readonly #options: WorkspaceDraftPersistenceOptions;
  #timer: unknown;
  ...
  constructor(options: WorkspaceDraftPersistenceOptions) {
